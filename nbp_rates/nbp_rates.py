#file generated at 2026-07-31 03:29:20
...
def ProvideCurrencyRate(date_given, currency, fallback=False, _depth=0):
    ...
    Data since 1984 till 2026-7-30 is available offline but if provided date is more recent then nbp api is used
    """
