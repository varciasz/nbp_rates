#file generated at 2026-09-02 03:53:25
...
def ProvideCurrencyRate(date_given, currency, fallback=False, _depth=0):
    ...
    Data since 1984 till 2026-9-1 is available offline but if provided date is more recent then nbp api is used
    """
