#file generated at 2026-09-15 04:19:11
...
def ProvideCurrencyRate(date_given, currency, fallback=False, _depth=0):
    ...
    Data since 1984 till 2026-9-14 is available offline but if provided date is more recent then nbp api is used
    """
