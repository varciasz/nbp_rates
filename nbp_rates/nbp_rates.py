#file generated at 2026-08-19 01:36:47
...
def ProvideCurrencyRate(date_given, currency, fallback=False, _depth=0):
    ...
    Data since 1984 till 2026-8-18 is available offline but if provided date is more recent then nbp api is used
    """
